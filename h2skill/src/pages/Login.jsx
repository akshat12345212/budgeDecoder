      ...
      <div className="glass-container">
        <div className="glass-card">
          <div className="login-header">
            <h1 className="title3d">Budget<span className="highlight">26</span></h1>
            <p className="subtitle">Welcome to your AI Financial Decoder</p>
          </div>
          ...
          <div className="login-buttons">
            <button
              className="glass-btn google-btn"
          ...
          <div className="login-footer">
            <p className="secured-text">Protected by Firebase Authentication</p>
          </div>
        </div>
      </div>
    </div>
